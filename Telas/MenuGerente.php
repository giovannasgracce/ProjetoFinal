...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="card">
                <h3>Funcionários</h3>
                <p>Mantenha as informações dos funcionários organizadas e atualizadas.</p>
                <a href="EscolhaFuncionario.php" class="btn">Acessar</a>
            </div>
            <div class="card">
                <h3>Resíduos</h3>
                <p>Gerencie e organize seus resíduos.</p>
                <a href="EscolhaResiduos.php" class="btn">Acessar</a>
            </div>
        </div>
    </section>
