...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="MenuGerente.php" class="button-cor">Voltar</a>
    ...
    <section class="hero">
        <div class="container">
            <div class="card">
                ...
                <a href="ExcluirFuncionario.php" class="btn">Acessar</a>
            </div>
            <div class="card">
                <h3>Cadastrar</h3>
                <p>Adicione novas informações facilmente.</p>
                <a href="CadastroFuncionario.php" class="btn">Acessar</a>
            </div>
            <div class="card">
                <h3>Atualizar</h3>
                <p>Atualize suas informações de forma rápida e prática.</p>
                <a href="AtualizarFuncionario.php" class="btn">Acessar</a>
            </div>
            <div class="card">
                <h3>Visualizar</h3>
                <p>Veja e acesse os dados registrados aqui</p>
                <a href="ConsultarFuncionario.php" class="btn">Acessar</a>
            </div>
        </div>
    </section>
